window.ROLEPLAY_SCENARIO = {
  ...
  audio: {
    ...
    appointmentLaterTime: "appointmentLaterTime",
    appointmentSingleTime: "appointmentSingleTime",
    appointmentMorningNeedDate: "appointmentMorningNeedDate",
  ...
  objections: {
    ...
    distance: {
      ...
      expected: "自宅から近い店舗、または家族と一緒の来店を提案する"
    },
    competitor: {
      label: "他店比較",
      customer: [
  ...
  recommendedTalks: {
    ...
    distance:
      "12カ月点検のほかに、オイル交換などのご用命や、その他お車で気になる点はございませんか。ご自宅から距離があり、ご来店がご負担なのですね。ご自宅から近い店舗をご案内する方法や、ご家族と一緒にご来店いただく方法もございます。どちらがご負担が少ないでしょうか。",
    competitor:
...
window.VEHICLE_INSPECTION_SCENARIO = {
  ...
  steps: [
    ...
    },
    {
      ...
      requiredGroups: [["トヨタモビリティ", "トヨタ"], ["です", "申します", "もうします"]],
