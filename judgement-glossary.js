(() => {
  ...
  const entries = {
    ...
    introduced_self: {
      condition: "店舗名と、特定の個人名に固定しない任意の担当者名の両方を名乗る。",
      words: ["トヨタモビリティ帯広", "トヨタモビリティ○○店", "○○と申します", "○○と、もうします", "○○でございます", "○○と言います"],
      aliases: ["とよたもびりてぃ → トヨタモビリティ", "おびひろ → 帯広", "もうします → 申します"],
      invalid: ["トヨタモビリティ帯広です（担当者名なし）", "○○と申します（店舗名なし）", "店舗名だけ", "担当者名だけ"],
      note: "担当者名は誰の名前でも構いません。店舗名と担当者名が同じ発話内にそろうことが必要です。"
    },
    thanked_customer: {
      condition: "日頃からの利用・関係に対するお礼を伝える。",
      words: ["いつもありがとうございます", "お世話になっております", "お世話になっています", "日頃はお世話になりありがとうございます", "ご利用ありがとうございます", "ご愛顧に感謝します"],
    ...
    asked_availability: {
      ...
      words: ["ご予定", "ご都合", "日程", "予約", "お決まり", "決められましたか", "いかがでしょうか"],
    ...
    explained_available_period: {
      ...
      aliases: ["くがつさんじゅうにち → 9月30日", "まんりょう → 満了"],
    ...
    explained_duration_and_wait: {
      ...
      aliases: ["そうこうきょり → 走行距離", "きょりすう → 距離数", "なんきろ → 何キロ", "九十分 → 90分"],
      invalid: ["3万キロです（質問なし）", "90分です（距離・待ち方なし）", "店内です（説明なし）"],
      note: "3条件は別々の発話でも合算します。走行距離は質問、店内待ちは説明または確認が必要です。"
    },
    explained_loaner: {
      condition: "通常は早期予約で代車を用意できると説明する。お客様が代車を希望した直後は、用意・準備・手配できると明確に承諾する。",
      words: ["代車", "代わりのお車", "代替車", "早めの予約", "用意できます", "ご準備します", "手配します", "空いてますよ", "大丈夫です"],
      aliases: ["だいしゃ → 代車", "代償 → 代車", "ようい → 用意", "じゅんび → 準備", "てはい → 手配", "だいじょうぶ → 大丈夫"],
      invalid: ["確認します", "用意できません", "空きがありません", "大丈夫ですか？", "大丈夫です（代車希望の文脈なし）"],
      note: "『大丈夫です』など代車を省略した肯定は、直前にお客様が代車を希望した場合だけ有効です。"
    },
  ...
  const aliasGroups = [
    { title: "店舗・氏名", from: ["とよたもびりてぃ", "豊田モビリティ", "おびひろ", "もうします", "さとう", "さいとう"], to: ["トヨタモビリティ", "帯広", "申します", "佐藤", "斉藤"] },
    ...
    { title: "走行距離・時間", from: ["そうこうきょり", "きょりすう", "なんきろ", "九十分", "一時間半"], to: ["走行距離", "距離数", "何キロ", "90分", "1時間半"] },
