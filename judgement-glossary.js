(() => {
  ...
  const entries = {
    ...
    introduced_self: {
      condition: "店舗名と担当者名の両方を名乗る。",
      words: ["トヨタモビリティ帯広", "トヨタモビリティ", "○○店", "山田です", "渕山と申します", "後藤ともうします"],
      aliases: ["とよたもびりてぃ → トヨタモビリティ", "おびひろ → 帯広", "ふちやま → 渕山"],
      invalid: ["トヨタです", "担当の山田です", "店舗名だけ", "担当者名だけ"],
      note: "『トヨタ』だけ、または氏名だけでは、店舗名と担当者名がそろいません。"
    },
    thanked_customer: {
  ...
  const aliasGroups = [
    { title: "店舗・氏名", from: ["とよたもびりてぃ", "豊田モビリティ", "おびひろ", "ふちやま", "さとう", "さいとう"], to: ["トヨタモビリティ", "帯広", "渕山", "佐藤", "斉藤"] },
