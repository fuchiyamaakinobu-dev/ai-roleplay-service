(() => {
  ...
  const entries = {
    confirmed_identity: {
      ...
      words: ["佐藤様", "佐藤さん", "斉藤様（音声誤認）", "お電話でしょうか", "お電話でよろしいですか", "ご本人ですか"],
    ...
    explained_documents: {
      condition: "「荷物・荷室・トランク・荷」のいずれかと「空・積・降・下」のいずれか、さらに車検証・自賠責・納税証明書の3種類を案内する。",
      words: ["荷物", "荷室", "トランク", "荷", "空", "積", "降", "下", "空荷", "車検証", "自賠責保険証明書", "納税証明書"],
      aliases: ["にもつ → 荷物", "しゃけんしょう → 車検証", "じばいせき → 自賠責", "のうぜいしょうめいしょ → 納税証明書"],
      invalid: ["必要書類をお持ちください", "車検証だけ", "荷物を降ろしてください（書類なし）"],
      note: "空荷側の2グループと3書類は別々の発話でも会話全体で合算します。『荷』または『空』など片方だけでは達成しません。"
    },
